...
date=`date +%Y%m%d`
outputname="$romtypename-$outputtype-$sourcever-$date-AlienGSIs"
...
sed -i "s/$bdisplay/$displayid2=Ported\.by\.AlienGSIs\.RB\.INTERNATIONAL/" $systemdir/system/build.prop
